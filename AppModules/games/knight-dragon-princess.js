...
function play(playerSelection) {
  ...
  switch (playerSelection){
    case "1": playerSelection = options[0]; break;
    case "2": playerSelection = options[1]; break;
    case "3": playerSelection = options[2]; break;
    default: console.log(dictionary.knightDragonAndPrincess.wrongInput);
  }
  const computerSelection = computerPlay();
  console.log(`${dictionary.knightDragonAndPrincess.yorChoice} ${playerSelection}`);
  console.log(`${dictionary.knightDragonAndPrincess.computerChoice} ${computerSelection}`);
...
const KnightDragonAndPrincessGame = () => {
  ...
  return new Promise((resolve) => {
    ...
    readline.question(
      dictionary.knightDragonAndPrincess.question,
      (answer) => {
